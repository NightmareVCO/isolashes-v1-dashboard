...
import { deleteProductCategory } from "@action/productCategory.action";
...
import ProductCategoryModal from "@ui/modals/ProductCategoryModal";
...
export function useProductCategoryTable() {
...
type ProductCategoryTableProperties = {
  categories: any;
  user: any;
};
...
export default function ProductCategoryTable({
  categories,
  user,
}: ProductCategoryTableProperties) {
  const {
    selectedCategory,
    handleSelectCategory,
    deleteSelectedCategory,
  ...
  return (
    <>
              ...
              <ModalBody className="flex flex-col items-center justify-center gap-2">
                <div className="flex items-center justify-between w-full h-full gap-3">
                  <div className="flex-2">
                    <Image
                      src={deleteSelectedCategory?.cover ?? "/placeholder.webp"}
      ...
      <Table isHeaderSticky aria-label="Categorías de Producto">
